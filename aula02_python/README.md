...
Material da aula 02, onde exploramos mais o conceito de variáveis, seus tipos e exercícios de operações para cada tipo.

Além disso, trabalhamos o tratamento de erros com TypeError, Type Check, Type Conversion, try-except e if.
...
#### TypeError, Type Check, Type Conversion e Condicionais
...
### Desafio do dia: Refatorar o projeto da aula anterior evitando Bugs!
